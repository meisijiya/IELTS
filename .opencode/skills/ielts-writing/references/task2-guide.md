...
**⚠️ 2026 评分微调**：若只写一方观点 + 一句话带过另一方，TR 直接扣分。**两方都要至少 2–3 句展开**。
...
| 模板套话堆砌 | CC 扣分 | 避免 "It is undeniable that ..."、"Last but not least, ..."、"With the development of society..." |
| 只答一个问题（Two-part） | TR 扣分 | 每问都要有独立段落 |
| 单段堆砌 5+ 句 | CC 扣分 | 拆成两段 |
| 句子超长（4+ 谓语） | GRA 扣分 | 拆分或用分词 / 定语右扩 |
| 拼写错误反复 | LR 扣分 | 消灭 2–3 个高频错词 |
| 反方观点未展开 | TR 扣分（2026 重点） | Discuss Both Views 两方都要 2–3 句 |
...
> ⚠️ **2026 机考调整**：机考建议前 5 分钟完成读题 + 提纲（打在草稿区），避免中途停顿。
...
| 话题 | 高频论点方向 | 关键搭配 |
|---|---|---|
| **AI 与工作** | AI 不会完全取代人类、创造性 / 情感工作难替代、政府应监管 | displace, augment, displace vs replace, regulatory framework |
| **远程办公** | 工作生活平衡提升、城市压力缓解、团队凝聚力下降 | hybrid working, remote-first, work-life balance |
| **社交媒体与青少年** | 心理健康影响、信息茧房、监管必要性 | mental health, algorithmic recommendation, digital well-being |
| **气候变化** | 个人 vs 系统责任、碳税、发达国家责任 | carbon footprint, net-zero, sustainability |
| **老龄化** | 养老金压力、延迟退休、移民政策 | ageing population, pension burden, longevity |
| **AI 与教育** | 个性化学习、批判性思维培养、教师角色转变 | adaptive learning, lifelong learning, teacher-student ratio |
| **城市 vs 乡村** | 城市化压力、乡村复兴、远程办公带动 | urbanisation, rural revitalisation, infrastructure |

---

## 十二、AI 辅助合规提醒（2026 必读）

IELTS 写作要求全程**独立完成**，禁止使用 AI 工具代写或润色。考试中包括：
- 监考巡视 + 屏幕监控（机考）
- 阅卷阶段 AI 生成文本检测器（Cambridge 2024 年起部署）
- 异常语言模式标记（如过度使用 AI 高频词 "delve"、"tapestry"、"landscape" 等）

**违规后果**：成绩永久取消 + 1–2 年禁考 + 通报送分机构。