---
id: T-022
goal: Task 1 essay — Mixed chart + table — library users survey (slug 09-mixed-library-survey) renders with full template + embedded chart extracted from docx.
files:
  - docs/writing/task1/09-mixed-library-survey.html
  - docs/assets/images/task1-charts/09-mixed-library-survey.png
deps: [T-018]
ac:
...
evidence: file exists at docs/writing/task1/09-mixed-library-survey.html; chart PNG at docs/assets/images/task1-charts/09-mixed-library-survey.png; bash scripts/verify-stage1b.sh docs/writing/task1/09-mixed-library-survey.html exits 0; word count in [170, 190]; Actions deploy green.
size: M
...
- **Title**: Mixed chart + table — library users survey
- **Slug**: `09-mixed-library-survey`
- **data-task**: task1
- **data-difficulty**: medium
- **data-type**: mixed-graph
...
7. Save PNG to `docs/assets/images/task1-charts/09-mixed-library-survey.png`.
8. Self-run `bash scripts/verify-stage1b.sh docs/writing/task1/09-mixed-library-survey.html` → must exit 0.
9. Commit + push.

## Acceptance criteria

- [ ] File `docs/writing/task1/09-mixed-library-survey.html` exists.
- [ ] File `docs/assets/images/task1-charts/09-mixed-library-survey.png` exists.
- [ ] `<article>` carries `data-task="task1"`, `data-difficulty="medium"`, `data-type="mixed-graph"` on same line.
...
- [ ] `bash scripts/verify-stage1b.sh docs/writing/task1/09-mixed-library-survey.html` exits 0.
...
- `docs/writing/task1/09-mixed-library-survey.html` (create).
- `docs/assets/images/task1-charts/09-mixed-library-survey.png` (create).
