---
id: T-024
goal: Task 1 essay — Dynamic chart — Melbourne social centre (slug 11-dynamic-melbourne-activities) renders with full template + embedded chart extracted from docx.
files:
  - docs/writing/task1/11-dynamic-melbourne-activities.html
  - docs/assets/images/task1-charts/11-dynamic-melbourne-activities.png
deps: [T-018]
ac:
...
evidence: file exists at docs/writing/task1/11-dynamic-melbourne-activities.html; chart PNG at docs/assets/images/task1-charts/11-dynamic-melbourne-activities.png; bash scripts/verify-stage1b.sh docs/writing/task1/11-dynamic-melbourne-activities.html exits 0; word count in [170, 190]; Actions deploy green.
size: M
...
- **Title**: Dynamic chart — Melbourne social centre
- **Slug**: `11-dynamic-melbourne-activities`
- **data-task**: task1
...
7. Save PNG to `docs/assets/images/task1-charts/11-dynamic-melbourne-activities.png`.
8. Self-run `bash scripts/verify-stage1b.sh docs/writing/task1/11-dynamic-melbourne-activities.html` → must exit 0.
9. Commit + push.

## Acceptance criteria

- [ ] File `docs/writing/task1/11-dynamic-melbourne-activities.html` exists.
- [ ] File `docs/assets/images/task1-charts/11-dynamic-melbourne-activities.png` exists.
...
- [ ] `bash scripts/verify-stage1b.sh docs/writing/task1/11-dynamic-melbourne-activities.html` exits 0.
...
- `docs/writing/task1/11-dynamic-melbourne-activities.html` (create).
- `docs/assets/images/task1-charts/11-dynamic-melbourne-activities.png` (create).
