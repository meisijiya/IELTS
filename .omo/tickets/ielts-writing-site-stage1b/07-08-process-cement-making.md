---
id: T-021
goal: Task 1 essay — Process cement + concrete making (slug 08-process-cement-making) renders with full template + embedded chart extracted from docx.
files:
  - docs/writing/task1/08-process-cement-making.html
  - docs/assets/images/task1-charts/08-process-cement-making.png
deps: [T-018]
ac:
...
evidence: file exists at docs/writing/task1/08-process-cement-making.html; chart PNG at docs/assets/images/task1-charts/08-process-cement-making.png; bash scripts/verify-stage1b.sh docs/writing/task1/08-process-cement-making.html exits 0; word count in [170, 190]; Actions deploy green.
size: M
...
- **Title**: Process cement + concrete making
- **Slug**: `08-process-cement-making`
- **data-task**: task1
...
7. Save PNG to `docs/assets/images/task1-charts/08-process-cement-making.png`.
8. Self-run `bash scripts/verify-stage1b.sh docs/writing/task1/08-process-cement-making.html` → must exit 0.
9. Commit + push.

## Acceptance criteria

- [ ] File `docs/writing/task1/08-process-cement-making.html` exists.
- [ ] File `docs/assets/images/task1-charts/08-process-cement-making.png` exists.
- [ ] `<article>` carries `data-task="task1"`, `data-difficulty="hard"`, `data-type="process"` on same line.
...
- [ ] `bash scripts/verify-stage1b.sh docs/writing/task1/08-process-cement-making.html` exits 0.
...
- `docs/writing/task1/08-process-cement-making.html` (create).
- `docs/assets/images/task1-charts/08-process-cement-making.png` (create).
